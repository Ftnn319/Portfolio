...
export function Card(){
    return (
        ...
        <div className="border border-gray-300 rounded-lg">
          <Image src="https://plus.unsplash.com/premium_photo-1720287601920-ee8c503af775?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Y29kaW5nfGVufDB8fDB8fHww" alt="placeholder" width={560} height={370} className="border-b-2xl border rounded-t-lg"/>
